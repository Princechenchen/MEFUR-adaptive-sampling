...
%%%超参数初始化%%%
model.corrfunc = "correxp";%["corrgauss","'correxpg'","correxp","corrcubic","corrlin","corrspherical","corrspline"],'':参数多一个
model.cov_model = @(hyp, x, z, i)covSEfunc(hyp, x, z,model.corrfunc);     % Define the covariance model (hbere we used the SEARD)
